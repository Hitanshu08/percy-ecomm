      ...
      <div className="p-4">
        ...
        {subscription.is_active ? (
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <Button onClick={onCopyAccountId} variant="primary" size="sm" title="Copy Account ID">
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Button onClick={onCopyPassword} variant="primary" size="sm" title="Copy Password">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
                      </svg>
                    </Button>
          ...
          <div className="text-center py-4">
            <p className="text-sm text-gray-500 dark:text-gray-400">This subscription is currently inactive</p>
          </div>
        )}
      </div>
    </div>
